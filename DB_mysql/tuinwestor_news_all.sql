...
--
-- Table structure for table `news_all`
--
...
CREATE TABLE `news_all` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=185176 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dump completed on 2022-07-20 13:31:49
