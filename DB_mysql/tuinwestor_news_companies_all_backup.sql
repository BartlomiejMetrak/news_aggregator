...
--
-- Table structure for table `news_companies_all_backup`
--

DROP TABLE IF EXISTS `news_companies_all_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `news_companies_all_backup` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10962 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='tabela z artykułami o spółkach - bez treści artykułów itp - do głównego feedu newsów';
...
-- Dump completed on 2022-07-20 13:31:52
